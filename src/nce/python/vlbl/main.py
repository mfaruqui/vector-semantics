...
if __name__=='__main__':
    ...
    parser.add_argument("-b", "--batchsize", type=int, default=500, help="Size of one batch update")
                    
    args = parser.parse_args()

    learner = LearningCorpus(args.freqcutoff, args.window, args.noise, args.numdim, args.inputfile)
    learner.train_on_corpus(args.numiterations, args.learningrate, args.batchsize)
